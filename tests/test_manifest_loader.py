...
class TestDefinitionNormAdvanced:
    ...
    def test_cumulative_different_windows_have_different_norms(self):
        ...
        assert by_name["cumulative_revenue_3d"].definition_norm != by_name["cumulative_revenue_7d"].definition_norm
    ...
    def test_derived_identical_twins_collide(self):
        ...
        formula_pairs = {frozenset([c["a"], c["b"]]) for c in collisions if c["kind"] == "formula"}
